                        ...
                        <form class="form-horizontal" action="users?action=changerole" method="POST">
                            ...
                            ********************************************************************************************************-->
                            <div class="form-group">
                                 <label for="inputEmail3" class="col-sm-2 control-label">User's Name</label>
                                <div class="col-sm-10">
                                    <input type="text" name="usersname" class="form-control" id="inputEmail3" required/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">Contacts</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="usercontacts" rows="3" required/></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">Faculty</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">Users Level/Role</label>
                                <div class="col-sm-10">
